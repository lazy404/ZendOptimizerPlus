...
ZEND_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("opcache.mmap_prefix"    , "/apc/opcache."    , PHP_INI_SYSTEM, OnUpdateString,	             accel_directives.mmap_prefix,   zend_accel_globals, accel_globals)
...
static ZEND_FUNCTION(opcache_get_configuration)
{
	...
	add_assoc_string(directives, "opcache.mmap_prefix",     STRING_NOT_NULL(ZCG(accel_directives).mmap_prefix), 1);
